...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://files.krs.ninja/krs%20code%20final.png Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    STICKER_DATA: process.env.STICKER_DATA || "KRS CODES",
    BOT_NAME: process.env.BOT_NAME || 'KRS CODES',
